...
def mock_notification_service():
    with patch('app.routers.payments.notify_landlord', new_callable=AsyncMock) as mock_notify,
         patch('app.main.notify_landlord', new_callable=AsyncMock) as mock_main_notify:
        mock_notify.return_value = None
        mock_main_notify.return_value = None
        yield mock_notify
